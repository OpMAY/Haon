                ...
                <div class="col-lg col-12 left-sidebar-container">
                    <div class="left-side-inner">
                        ...
                        <ul class="list-group _left-tabs">
                            ...
                            <li class="list-group-item regular-h4 c-gray-dark-low _left-tab-item is-active" data-href="#">알림 설정</li>
                                    ...
                                    <table class="table table-borderless _option-table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="_option-toggle pt-0">
                                                ...
                                                <div class="text-center">
                                                    <label data-label="checkbox" class="radio-item">
                                                        <input data-type="radio" type="radio" name="radio2">
                                                        <span class="design"></span>
                                                        <span class="text"></span>
                                                    </label>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="_option-toggle">
                                                <div class="text-center pt-24">
                                                    <label data-label="checkbox" class="radio-item">
                                                        <input data-type="radio" type="radio" name="radio3">
                                                        <span class="design"></span>
                                                        <span class="text"></span>
                                                    </label>
                                                </div>
                                            ...
                                            <td class="_option-toggle">
                                                <div class="text-center pt-24">
                                                    <label data-label="checkbox" class="radio-item">
                                                        <input data-type="radio" type="radio" name="radio4">
                                                        <span class="design"></span>
                                                        <span class="text"></span>
                                                    </label>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="_option-toggle">
                                                <div class="text-center pt-24">
                                                    <label data-label="checkbox" class="radio-item">
                                                        <input data-type="radio" type="radio" name="radio5">
                                                        <span class="design"></span>
                                                        <span class="text"></span>
                                                    </label>
                                                </div>
                                            ...
                                            <td class="_option-toggle">
                                                <div class="text-center pt-24">
                                                    <label data-label="checkbox" class="radio-item">
                                                        <input data-type="radio" type="radio" name="radio6">
                                                        <span class="design"></span>
                                                        <span class="text"></span>
                                                    </label>
                                                </div>
