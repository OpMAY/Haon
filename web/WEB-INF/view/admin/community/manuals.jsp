            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">축산 메뉴얼</li>
                                </ol>
                            </div>
                            <h4 class="page-title">축산 메뉴얼</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">총 ${manuals.size()}개의 축산 메뉴얼 게시글</h4>
                                ...
                                <table id="basic-datatable"
                                    ...
                                    <c:forEach items="${manuals}" var="manual" varStatus="status">
                                        <tr>
                                            <td>${status.count}</td>
                                            <td><span class="badge bg-dark">${manual.category}</span></td>
                                            <td>${manual.title}</td>
                                            <td>${manual.farm.name}</td>
                                            <td>${manual.likes}</td>
                                            <td>${manual.comments}</td>
                                            <td>${manual.views}</td>
                                            <td>
                                                <custom:formatDatetime value="${manual.reg_datetime}" pattern="yyyy.MM.dd"/>
                                            </td>
                                            <td>
                                                <button type="button" data-href="/admin/manual/detail/${manual.no}"
