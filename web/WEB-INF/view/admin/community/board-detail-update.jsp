            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="/admin/board/detail/${board.no}">자유 게시판</a>
                                    </li>
                                    <li class="breadcrumb-item active">자유 게시판 수정</li>
                                </ol>
                            </div>
                            <h4 class="page-title">자유 게시판 수정</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-4">자유 게시판 수정
                                    <div class="float-end">
                                        <button type="button"
                                ...
                                <form action="/admin/board/update/${board.no}"
                                      method="POST"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="category">
                                                    ...
                                                    <c:forEach items="${communityCategory.categories}" var="category">
                                                        <c:choose>
                                                            <c:when test="${category eq board.category}">
                                                                <option selected
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <p class="text-muted">
                                                <custom:formatDatetime value="${board.reg_datetime}"
                                                                       pattern="yyyy.MM.dd"/>
                                            </p>
                                        </div>
                                        <div class="col-auto">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#summernote').summernote('code', '${board.content}'.replaceAll('&#39;', '\''));
