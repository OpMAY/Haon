            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">총 ${questions.size()}개의 질문과 답변 게시글</h4>
                                ...
                                <table id="basic-datatable"
                                    ...
                                    <c:forEach items="${questions}" var="question" varStatus="status">
                                        <tr>
                                            <td>${status.count}</td>
                                            <td><span class="badge bg-dark">${question.category}</span></td>
                                            <td>${question.title}</td>
                                            <td>${question.farm.name}</td>
                                            ...
                                            <td>
                                                <button type="button" data-href="/admin/question/detail/${question.no}"
