                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="/admin/tips">커뮤니티 관리(팁과 노하우)</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/admin/tip/detail/${tip.no}">팁과 노하우</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="/admin/tip/update/${tip.no}"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="file"
                                                       ...
                                                       data-thumbnail-image-url="${tip.thumbnail.url}"
                                                       data-thumbnail-image-size="${tip.thumbnail.size}"
                                                       data-thumbnail-image-name="${tip.thumbnail.name}"
                                                       data-thumbnail-image-type="${tip.thumbnail.type}"
                                                       data-default-file="${tip.thumbnail.url}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="category">
                                                    ...
                                                    <c:forEach items="${communityCategory.categories}" var="category">
                                                        <c:choose>
                                                            <c:when test="${category eq tip.category}">
                                                                <option selected
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <p class="text-muted">
                                                <custom:formatDatetime value="${tip.reg_datetime}"
                                                                       pattern="yyyy.MM.dd"/>
                                            </p>
                                        </div>
                                        <div class="col-auto">
                                            <label class="mb-2">작성자</label>
                                            <p class="text-muted">${tip.farm.name}</p>
                                        </div>
                                        <div class="col-auto">
                                            <label class="mb-2">좋아요</label>
                                            <p class="text-muted">${tip.likes}</p>
                                        </div>
                                        <div class="col-auto">
                                            <label class="mb-2">댓글 수</label>
                                            <p class="text-muted">${tip.comments}</p>
                                        </div>
                                        <div class="col-auto">
                                            <label class="mb-2">Views</label>
                                            <p class="text-muted">${tip.views}</p>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <h4 class="mt-0 mb-1">코멘트 (${tip.comments})</h4>
                                            <div class="mt-2">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#summernote').summernote('code', '${tip.content}'.replaceAll('&#39;', '\''));
