            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="/admin/questions">커뮤니티 관리(질문과
                                        답변)</a></li>
                                    <li class="breadcrumb-item"><a href="/admin/question/detail/${question.no}">질문과 답변</a>
                                    </li>
                                    <li class="breadcrumb-item active">질문과 답변 수정</li>
                                </ol>
                            </div>
                            <h4 class="page-title">질문과 답변 수정</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-4">질문과 답변 수정
                                    <div class="float-end">
                                        <button type="button"
                                ...
                                <form action="/admin/question/update/${question.no}"
                                      method="POST"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="category">
                                                    ...
                                                    <c:forEach items="${communityCategory.categories}" var="category">
                                                        <c:choose>
                                                            <c:when test="${category eq question.category}">
                                                                <option selected
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <p class="text-muted">
                                                <custom:formatDatetime value="${question.reg_datetime}"
                                                                       pattern="yyyy.MM.dd"/>
                                            </p>
                                        </div>
                                        <div class="col-auto">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#summernote').summernote('code', '${question.content}'.replaceAll('&#39;', '\''));
