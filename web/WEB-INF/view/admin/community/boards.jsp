            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">총 ${boards.size()}개의 자유 게시판 게시글</h4>
                                ...
                                <table id="basic-datatable"
                                    ...
                                    <c:forEach items="${boards}" var="board" varStatus="status">
                                        <tr>
                                            <td>${status.count}</td>
                                            <td><span class="badge bg-dark">${board.category}</span></td>
                                            <td>${board.title}</td>
                                            <td>${board.farm.name}</td>
                                            <td>${board.likes}</td>
                                            <td>${board.comments}</td>
                                            <td>${board.views}</td>
                                            <td>
                                                <custom:formatDatetime value="${board.updated_datetime}"
                                                                       pattern="yyyy.MM.dd"/>
                                            </td>
                                            <td>
                                                <button type="button" data-href="/admin/board/detail/${board.no}"
