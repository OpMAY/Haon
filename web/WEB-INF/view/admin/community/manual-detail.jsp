            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-4">축산 메뉴얼 정보
                                    <div class="float-end">
                                        <button type="button"
                                                data-href="/admin/manual/update/${manual.no}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <p class="text-muted">${manual.title}</p>
                                    </div>
                                    <div class="col-auto">
                                        <label class="mb-1">카테고리</label>
                                        <p class="text-muted">
                                            <span class="badge bg-primary">${manual.category}</span>
                                        </p>
                                    </div>
                                    <div class="col-auto">
                                        <label class="mb-1">작성 일자</label>
                                        <p class="text-muted"><custom:formatDatetime value="${manual.reg_datetime}"
