            ...
            <div class="row">
                <div class="col-xl-9 col-12">
                    <div class="community-container">
                        <c:if test="${magazine.thumbnail.url ne null}">
                                ...
                                if (result.status === 'OK') {
                                    if (result.data.status) {
                                        ...
                                        if (Kakao !== null && Kakao !== undefined) {
                                            let templateArgs = {
                                                community_thumbnail: '${magazine.thumbnail.url}',
                                                title: `${magazine.title}`,
                                                description: `<custom:formatHTMLToString value="${magazine.content}"/>`,
                                                likes: ${likes.size()},
                                            ...
                                            let kakaoLink = new KakaoLink(result.data.key, Kakao, {
                                                ...
                                                templateArgs,
                                                callback: () => {
                                                    kakaoLink.linkSendCallback(templateArgs);
                                                }
                                            });
                                        } else {
