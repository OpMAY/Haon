        ...
        <section class="section sm-section mt-40 mb-40"
            ...
            <div class="filter-dropdown-container">
                <div class="dropdown input-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-md" data-item="tip" data-type="to">
                ...
                <div class="dropdown input-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-md" data-item="tip" data-type="category">
                            <a class="dropdown-item c-gray-light medium-h5">
                ...
                <div class="right-filter-dropdown-container">
                    <div class="dropdown input-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-sm" data-item="tip" data-type="order">
                            <a class="dropdown-item c-gray-light medium-h5">
