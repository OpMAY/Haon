...
<%@ page import="com.model.content.manual.ManualTransaction" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.model.content.manual.ManualComment" %>
...
<%
    ...
    ArrayList<ManualTransaction> likes = (ArrayList<ManualTransaction>) request.getAttribute("likes");
    ...
    ArrayList<ManualComment> comments = (ArrayList<ManualComment>) request.getAttribute("comments");
    request.setAttribute("comments", comments);

    Farm farm = (Farm) request.getAttribute("farm");
    request.setAttribute("farm", farm);
    ArrayList<Manual> other_manuals = (ArrayList<Manual>) request.getAttribute("other_manuals");
    request.setAttribute("other_manuals", other_manuals);
%>
<html lang="ko">
            ...
            <div class="row">
                <div class="col-xl-9 col-12">
                    <div class="community-container">
                        <c:if test="${manual.thumbnail.url ne null}">
                        ...
                        <div class="_detail">
                                ...
                                <div class="_right-option">
                                    ...
                                    <c:choose>
                                        <c:when test="${is_bookmark eq true}">
                                            <svg class="bookmark is-active" data-no="${manual.no}"
                                                 data-detail-bookmark="MANUAL"
                                        ...
                                        <c:otherwise>
                                            <svg class="bookmark" data-no="${manual.no}" data-detail-bookmark="MANUAL"
                                                 width="32"
                            ...
                            <div class="_breadcrumb">
                                <span data-href="#" class="c-brand-green medium-h5">축산 메뉴얼</span>
                                <span data-href="#" class="c-brand-green medium-h5">${manual.category}</span>
                            </div>
                            ...
                            <div class="_detail-footer">
                                <c:choose>
                                    <c:when test="${is_like eq true}">
                                        <div data-no="${manual.no}" data-detail-like="MANUAL" class="_like is-active">
                                    ...
                                    <c:otherwise>
                                        <div data-no="${manual.no}" data-detail-like="MANUAL" class="_like">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <g clip-path="url(#clip0_261_12739)">
                                                    <path d="M9.7335 5.33333H14.0002C14.3538 5.33333 14.6929 5.47381 14.943 5.72386C15.193 5.97391 15.3335 6.31304 15.3335 6.66667V8.06933C15.3337 8.24357 15.2997 8.41616 15.2335 8.57733L13.1695 13.5867C13.1193 13.7088 13.034 13.8133 12.9243 13.8869C12.8146 13.9605 12.6856 13.9999 12.5535 14L1.33349 14C1.15668 14 0.987114 13.9298 0.862089 13.8047C0.737065 13.6797 0.666828 13.5101 0.666828 13.3333L0.666828 6.66667C0.666828 6.48986 0.737065 6.32029 0.862089 6.19526C0.987114 6.07024 1.15668 6 1.33349 6H3.65483C3.76156 6.00003 3.86674 5.97443 3.96152 5.92536C4.0563 5.87628 4.13791 5.80517 4.19949 5.718L7.83483 0.567333C7.88078 0.502208 7.94856 0.455707 8.02585 0.43626C8.10315 0.416813 8.18486 0.425708 8.25616 0.461333L9.4655 1.06667C9.80583 1.23677 10.0777 1.51821 10.236 1.86421C10.3942 2.21021 10.4294 2.59995 10.3355 2.96867L9.7335 5.33333ZM4.66683 7.05867V12.6667L12.1068 12.6667L14.0002 8.06933V6.66667L9.7335 6.66667C9.53043 6.66664 9.33005 6.62023 9.14765 6.53097C8.96525 6.44172 8.80564 6.31198 8.68101 6.15166C8.55638 5.99133 8.47002 5.80466 8.42851 5.60588C8.387 5.4071 8.39144 5.20147 8.4415 5.00467L9.04349 2.63933C9.06234 2.56555 9.05535 2.48754 9.02369 2.41829C8.99203 2.34903 8.93762 2.2927 8.8695 2.25867L8.42883 2.03867L5.28883 6.48667C5.12216 6.72267 4.90883 6.916 4.66683 7.05867V7.05867ZM3.33349 7.33333H2.00016V12.6667H3.33349V7.33333Z"/>
                                ...
                                <div class="_views medium-h5 c-gray-light">
                                    <span class="mr-1">${manual.views}</span>Views
                                </div>
                            </div>
                        </div>
                        <div class="_comments">
                            <div class="form-group form-inner-button">
                                <input data-type="MANUAL" data-no="${manual.no}" type="text" placeholder="댓글을 입력하세요."
                                            ...
                                            <div class="_responds">
                                                <c:choose>
                                                    <c:when test="${comment._like eq true}">
                                                        <div class="_like is-active" data-comment-like="MANUAL"
                                                             data-no="${comment.no}">
                                                            <svg width="16"
                                                                 height="14"
                                                                 viewBox="0 0 16 14"
                                                    ...
                                                    <c:otherwise>
                                                        <div class="_like" data-comment-like="MANUAL"
                                                             data-no="${comment.no}">
                                                            <svg width="16"
                                                                 height="14"
                                                                 viewBox="0 0 16 14"
                                                ...
                                                <c:choose>
                                                    <c:when test="${comment._dislike eq true}">
                                                        <div class="_dislike is-active" data-comment-dislike="MANUAL"
                                                             data-no="${comment.no}">
                                                            <svg width="16"
                                                                 height="14"
                                                                 viewBox="0 0 16 14"
                                                    ...
                                                    <c:otherwise>
                                                        <div class="_dislike" data-comment-dislike="MANUAL"
                                                             data-no="${comment.no}">
                                                            <svg width="16"
                                                                 height="14"
                                                                 viewBox="0 0 16 14"
                                            ...
                                            <div class="_reply">
                                                <c:if test="${comment.owner_checked eq true}">
                                                    <span class="medium-h5 c-gray-dark-low _delete"
                                                          data-no="${comment.no}" data-type="MANUAL"
                                                          data-parent="parent">삭제</span>
                                                </c:if>
                                                <span class="medium-h5 c-gray-dark-low _do"
                                                      data-comment-no="${comment.no}" data-type="MANUAL"
                                                      data-no="${manual.no}">답글</span>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="_reply">
                                                                <c:if test="${recomment.owner_checked eq true}">
                                                                    <span class="medium-h5 c-gray-dark-low _delete mr-0"
                                                                          data-no="${recomment.no}" data-type="MANUAL"
                                        ...
                                        <div class="_community-module">
                                            ...
                                            <div class="row row-cols-1 community-container-deck">
                                                <c:forEach items="${other_manuals}" var="other_manual"
                                                           varStatus="status">
                                                    <c:choose>
                                                        <c:when test="${other_manual.thumbnail.url ne null}">
                                                            <div class="col-12 p-8"
                                                                 data-href="/community/manual/detail/${other_manual.no}">
                                                                <div class="card community-card">
                                                                    <div class="background-image _thumbnail _thumbnail-lg"
                                                                         style="background-image:url('${other_manual.thumbnail.url}')">
                                                                        <div class="background-image _profile"
                                                                             style="background-image:url('${farm.profile_image.url}')"></div>
                                                                    </div>
                                                                    <div class="card-body _body">
                                                                        <h5 class="card-title _title bold-h4 c-gray-dark-low">${other_manual.title}</h5>
                                                                        <div class="card-text _description medium-h5 c-gray-medium">${other_manual.content}</div>
                                                                    </div>
                                                                    <div class="_footer">
                                                                        <span class="_views medium-p1 c-gray-light">
                                                                            <span class="_count">${other_manual.views}</span>Views
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                if (result.status === 'OK') {
                                    if (result.data.status) {
                                        ...
                                        if (Kakao !== null && Kakao !== undefined) {
                                            let templateArgs = {
                                                community_thumbnail: '${manual.thumbnail.url}',
                                                title: `${manual.title}`,
                                                description: `<custom:formatHTMLToString value="${manual.content}"/>`,
                                                likes: ${likes.size()},
