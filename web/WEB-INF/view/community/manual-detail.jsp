                ...
                <div class="col-xl-9 col-12">
                    <div class="community-container">
                        <div class="_thumbnail background-image"
                             style="padding-top: 32%; background-image:
                 url('../../resources/assets/images/sample/background-wallpaper1.png')"></div>
                        <div class="_detail">
                            <div class="_title ellipsis-one-line bold-h2 c-gray-dark-low">
                                <span>염소를 어떻게 키우나요?염소를 어떻게 키우나요?염소를 어떻게 키우나요?염소를 어떻게 키우나요?</span>
                            ...
                            <div class="_breadcrumb">
                                ...
                                <span data-href="#" class="c-brand-green medium-h5">기타</span>
                            </div>
                            ...
                            <div class="_detail-footer">
                                <div class="_like is-active">
                                    ...
                                    <span class="ml-1 regular-h5">12</span>
                                </div>
                                <div class="_views medium-h5 c-gray-light">
                                    <span class="mr-1">32</span>Views
                                </div>
                            </div>
                        </div>
                        <div class="_comments">
                          ...
                          <rect width="24.0923" height="24" transform="translate(0.0500488)"></rect>
                                        ...
                                        <div class="col-12 p-8">
                                            <div class="card community-card is-empty">
                                                <div class="card-body _body">
                                                    <h5 class="card-title _title bold-h4 c-gray-dark-low">양소 잘 키우는 법</h5>
                                                    <p class="card-text _description medium-h5 c-gray-medium">Lorem ipsum dolor sit amet,
                                                        consectetur
                                                        adipisicing elit. Adipisci aliquid aperiam at doloremque exercitationem explicabo fugit,
                                                        laudantium
                                                        minus nam pariatur quibusdam quidem quod recusandae reiciendis sunt voluptate voluptatum.
                                                        Aut,
                                                        cum.</p>
                                                </div>
                                                <div class="_footer">
