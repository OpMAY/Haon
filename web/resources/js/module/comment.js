    ...
    return `<div class="comment-container">
                <div class="_comment">
                    ...
                    <div class="_transactions">
                        <div class="_responds">
                            <div class="_like" data-comment-like="BOARD" data-no="${comment.no}">
                            ...
                            <div class="_dislike" data-comment-dislike="BOARD" data-no="10">
                                <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="_reply" data-no="${comment.no}" data-type="event">
                            ...
                            <span class="medium-h5 c-gray-dark-low _do" data-comment-no="${comment.no}" data-type="${type}" data-no="${comment.board_no}">답글</span>
                        </div>
                    </div>
                </div>
