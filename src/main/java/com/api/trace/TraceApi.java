...
//        log.info("res : {}", response);
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=navZSiGlAISRynqdYKsv5Nq%2BnXtZ4RV0pv%2FxFXbyTfgJce5UroOiCsafnkxfTYe1YXuTAB1qHNHUgkFLgNw7MQ%3D%3D"); /*Service Key*/
